...
g_pfnVectors:
  ...
  /* External Interrupts */
  .word  WWDG2_IRQHandler           /*  Window1 Watchdog interrupt  */                     
  ...
  .word  AHB_ICACHE_IRQHandler      /*  CM4 AHB iCache interrupt */
  .word  AHB_DCACHE_IRQHandler      /*  CM4 AHB dCache interrupt */
  .word  FPU_CPU2_IRQHandler		    /*  FPU_CM4 global interrupt	*/	
  ...
  .word  AHB_CACHE_PARMON_IRQHandler /*  AHB i/dCACHE parity error intertupt  */
  ...
  .word  0                           /*  Reserved  */
  .word  SEMA4_INT2_IRQHandler       /*  SEMA4 interrupt2  */
...
**/
  ...
  .weak      AHB_ICACHE_IRQHandler
  .thumb_set AHB_ICACHE_IRQHandler,Default_Handler

  .weak      AHB_DCACHE_IRQHandler
  .thumb_set AHB_DCACHE_IRQHandler,Default_Handler

  .weak      FPU_CPU2_IRQHandler
  .thumb_set FPU_CPU2_IRQHandler,Default_Handler
  ...
  .weak      AHB_CACHE_PARMON_IRQHandler
  .thumb_set AHB_CACHE_PARMON_IRQHandler,Default_Handler
  ...
  .weak      SEMA4_INT2_IRQHandler
  .thumb_set SEMA4_INT2_IRQHandler,Default_Handler
