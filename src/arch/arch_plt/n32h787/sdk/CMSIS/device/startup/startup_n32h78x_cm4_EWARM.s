...
__vector_table
        ...
        DCD     CACHE_PARITY_ER_IRQHandler ; AHB i/dCACHE parity error intertupt
...
SDPU_IRQHandler
        ...
        PUBWEAK AHB_ICACHE_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
AHB_ICACHE_IRQHandler
        B AHB_ICACHE_IRQHandler

        PUBWEAK AHB_DCACHE_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
AHB_DCACHE_IRQHandler
        B AHB_DCACHE_IRQHandler

        PUBWEAK FPU_CPU2_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
FPU_CPU2_IRQHandler
        B FPU_CPU2_IRQHandler
...
DSI_IRQHandler
        ...
        PUBWEAK CACHE_PARITY_ER_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
CACHE_PARITY_ER_IRQHandler
        B CACHE_PARITY_ER_IRQHandler
...
WAKEUP_IO_IRQHandler
        ...
        PUBWEAK SEMA4_INT2_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
SEMA4_INT2_IRQHandler
        B SEMA4_INT2_IRQHandler
